export const BUTTON_CLASSNAMES = {
  ...
  'solid-grey':
    'border-none bg-neutral/20 text-neutral hover:bg-neutral hover:text-neutral-content',
  'solid-light':
  ...
  'outline-grey':
    'btn-outline border-neutral/50 hover:bg-neutral hover:border-transparent hover:text-neutral-content',
  text: 'btn-ghost',
  'text-link': 'btn-link',
