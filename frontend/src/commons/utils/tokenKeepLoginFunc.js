...
const UseTokenKeepLogin = () => {
  ...
  const setTokenKeepLogin = (token) => cookies.set('token_keep_login', token, {path:'/'})
  ...
  return ({ getTokenKeepLogin, setTokenKeepLogin, clearTokenKeepLogin, isTokenKeepLoginExist, getTokenKeepLoginPayload })
}
